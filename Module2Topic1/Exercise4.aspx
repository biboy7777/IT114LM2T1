...
<body>
    ...
    <form runat="server">
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" Type="Integer" MinimumValue="0" MaximumValue="100" ErrorMessage="Please enter a valid age. (Age must be between 0-100)" />
        <br />
        <br />
        ...
        <asp:RegularExpressionValidator runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ErrorMessage="Please enter a valid email address." />
        <br />
        <br />
        ...
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" Operator="Equal" Type="String" ErrorMessage="Please make sure the email addresses are matched." />
        <br />
        <br />

        <asp:Button ID="submitBtn" Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="submitBtn_Click" />
        <br />
        <br />
