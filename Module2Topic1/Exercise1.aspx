...
<body>
    ...
    <form runat="server">
        ...
        <asp:Label ID="labelSong" runat="server" Text="Can't Help Falling in Love - Elvis Presley"></asp:Label>
        <br />
        <br />
        ...
        <span id ="nowPlayingSpan" runat="server" visible="false">Now playing: <asp:Label ID="songPlayed" runat="server"></asp:Label> </span>
        <br />
